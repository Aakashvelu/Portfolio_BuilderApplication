...
const Dash = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      // After successful deletion, clear the details and redirect to another page if needed
      setDetails(null);
    } catch (error) {
      ...
      <div className="profile-container">
        ...
        {editMode ? (
          <div>
            ...
            <p><strong>Address:</strong> <input type="text" name="address" value={editedDetails.address || details.address} onChange={handleInputChange} /></p>
